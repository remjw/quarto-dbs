...
> `Leaving Assignments Comments at Canvas is the last method for time-senstive/urgent message` when you need a quick response from the instructor.
...
> Find the virtual office hours in the syllabus.
...
3.  Deadline and Time Zone difference: The class is set to Eastern Time Zone(EST). Canvas is based on Eastern Time Zone (EST).

> Be aware of this time difference if you are in Central Time Zone. If an assignment is due on Friday at 11:59PM (EST), at Canvas, you will see the due time is displayed as 10:59PM, Friday in local time unless you change your user settings at Canvas.
